...
var properties = ({
        final x = new GoMap<GoString, Ref<stdgo.unicode.Unicode.RangeTable>>();
        x.__setInitData__([
("ASCII_Hex_Digit" : GoString) => ascii_Hex_Digit,
...
var foldCategory = ({
        final x = new GoMap<GoString, Ref<stdgo.unicode.Unicode.RangeTable>>();
        x.__setInitData__([("L" : GoString) => _foldL, ("Ll" : GoString) => _foldLl, ("Lt" : GoString) => _foldLt, ("Lu" : GoString) => _foldLu, ("M" : GoString) => _foldM, ("Mn" : GoString) => _foldMn]);
        x;
    });
/**
...
var foldScript = ({
        final x = new GoMap<GoString, Ref<stdgo.unicode.Unicode.RangeTable>>();
        x.__setInitData__([("Common" : GoString) => _foldCommon, ("Greek" : GoString) => _foldGreek, ("Inherited" : GoString) => _foldInherited]);
        x;
    });
/**
