...
**/
private var _globTests = (new Slice<T__struct_0>(0, 0, ({ _pattern : ("match.go" : GoString), _result : ("match.go" : GoString) } : T__struct_0), ({ _pattern : ("mat?h.go" : GoString), _result : ("match.go" : GoString) } : T__struct_0), ({ _pattern : ("*" : GoString), _result : ("match.go" : GoString) } : T__struct_0), ({ _pattern : ("../*/match.go" : GoString), _result : ("../filepath/match.go" : GoString) } : T__struct_0)) : Slice<T__struct_0>);
/**
    
    
    
**/
private var _globSymlinkTests = (new Slice<T__struct_1>(0, 0, ({ _path : ("test1" : GoString), _dest : ("link1" : GoString), _brokenLink : false } : T__struct_1), ({ _path : ("test2" : GoString), _dest : ("link2" : GoString), _brokenLink : true } : T__struct_1)) : Slice<T__struct_1>);
/**
...
**/
private var _nonwincleantests = (new Slice<stdgo.path.filepath_test.Filepath_test.PathTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.PathTest(("//abc" : GoString), ("/abc" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("///abc" : GoString), ("/abc" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("//abc//" : GoString), ("/abc" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest)) : Slice<stdgo.path.filepath_test.Filepath_test.PathTest>);
/**
...
**/
private var _plan9islocaltests = (new Slice<stdgo.path.filepath_test.Filepath_test.IsLocalTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.IsLocalTest(("#a" : GoString), false) : stdgo.path.filepath_test.Filepath_test.IsLocalTest)) : Slice<stdgo.path.filepath_test.Filepath_test.IsLocalTest>);
/**
    
    
    
**/
private var _slashtests = (new Slice<stdgo.path.filepath_test.Filepath_test.PathTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.PathTest(Go.str(), Go.str()) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("/" : GoString), ((47 : GoInt32) : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("/a/b" : GoString), ((new Slice<GoUInt8>(0, 0, (47 : GoUInt8), (97 : GoUInt8), (47 : GoUInt8), (98 : GoUInt8)) : Slice<GoUInt8>) : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("a//b" : GoString), ((new Slice<GoUInt8>(0, 0, (97 : GoUInt8), (47 : GoUInt8), (47 : GoUInt8), (98 : GoUInt8)) : Slice<GoUInt8>) : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest)) : Slice<stdgo.path.filepath_test.Filepath_test.PathTest>);
/**
    
    
    
**/
private var _splitlisttests = (new Slice<stdgo.path.filepath_test.Filepath_test.SplitListTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.SplitListTest(Go.str(), (new Slice<GoString>(0, 0) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest), (new stdgo.path.filepath_test.Filepath_test.SplitListTest(((new Slice<GoUInt8>(0, 0, (97 : GoUInt8), (58 : GoUInt8), (98 : GoUInt8)) : Slice<GoUInt8>) : GoString), (new Slice<GoString>(0, 0, ("a" : GoString), ("b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest), (new stdgo.path.filepath_test.Filepath_test.SplitListTest(((new Slice<GoUInt8>(0, 0, (58 : GoUInt8), (97 : GoUInt8), (58 : GoUInt8), (98 : GoUInt8)) : Slice<GoUInt8>) : GoString), (new Slice<GoString>(0, 0, Go.str(), ("a" : GoString), ("b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest)) : Slice<stdgo.path.filepath_test.Filepath_test.SplitListTest>);
/**
...
0,
0,
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("\"a\"" : GoString), (new Slice<GoString>(0, 0, ("a" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("\";\"" : GoString), (new Slice<GoString>(0, 0, (";" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("\"a;b\"" : GoString), (new Slice<GoString>(0, 0, ("a;b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("\";\";" : GoString), (new Slice<GoString>(0, 0, (";" : GoString), Go.str()) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest((";\";\"" : GoString), (new Slice<GoString>(0, 0, Go.str(), (";" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("a\";\"b" : GoString), (new Slice<GoString>(0, 0, ("a;b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("a; \"\"b" : GoString), (new Slice<GoString>(0, 0, ("a" : GoString), (" b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("\"a;b" : GoString), (new Slice<GoString>(0, 0, ("a;b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("\"\"a;b" : GoString), (new Slice<GoString>(0, 0, ("a" : GoString), ("b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("\"\"\"a;b" : GoString), (new Slice<GoString>(0, 0, ("a;b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("\"\"\"\"a;b" : GoString), (new Slice<GoString>(0, 0, ("a" : GoString), ("b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("a\";b" : GoString), (new Slice<GoString>(0, 0, ("a;b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("a;b\";c" : GoString), (new Slice<GoString>(0, 0, ("a" : GoString), ("b;c" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo.path.filepath_test.Filepath_test.SplitListTest(("\"a\";b\";c" : GoString), (new Slice<GoString>(0, 0, ("a" : GoString), ("b;c" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.SplitListTest)) : Slice<stdgo.path.filepath_test.Filepath_test.SplitListTest>);
/**
    
    
    
**/
private var _unixsplittests = (new Slice<stdgo.path.filepath_test.Filepath_test.SplitTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.SplitTest(("a/b" : GoString), ("a/" : GoString), ("b" : GoString)) : stdgo.path.filepath_test.Filepath_test.SplitTest), (new stdgo.path.filepath_test.Filepath_test.SplitTest(("a/b/" : GoString), ("a/b/" : GoString), Go.str()) : stdgo.path.filepath_test.Filepath_test.SplitTest), (new stdgo.path.filepath_test.Filepath_test.SplitTest(("a/" : GoString), ("a/" : GoString), Go.str()) : stdgo.path.filepath_test.Filepath_test.SplitTest), (new stdgo.path.filepath_test.Filepath_test.SplitTest(("a" : GoString), Go.str(), ("a" : GoString)) : stdgo.path.filepath_test.Filepath_test.SplitTest), (new stdgo.path.filepath_test.Filepath_test.SplitTest(("/" : GoString), ("/" : GoString), Go.str()) : stdgo.path.filepath_test.Filepath_test.SplitTest)) : Slice<stdgo.path.filepath_test.Filepath_test.SplitTest>);
/**
...
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, Go.str()) : Slice<GoString>), Go.str()) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("/" : GoString)) : Slice<GoString>), ("/" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("a" : GoString)) : Slice<GoString>), ("a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("a" : GoString), ("b" : GoString)) : Slice<GoString>), ("a/b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("a" : GoString), Go.str()) : Slice<GoString>), ("a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, Go.str(), ("b" : GoString)) : Slice<GoString>), ("b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("/" : GoString), ("a" : GoString)) : Slice<GoString>), ("/a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("/" : GoString), ("a/b" : GoString)) : Slice<GoString>), ("/a/b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("/" : GoString), Go.str()) : Slice<GoString>), ("/" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("/a" : GoString), ("b" : GoString)) : Slice<GoString>), ("/a/b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("a" : GoString), ("/b" : GoString)) : Slice<GoString>), ("a/b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("/a" : GoString), ("/b" : GoString)) : Slice<GoString>), ("/a/b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("a/" : GoString), ("b" : GoString)) : Slice<GoString>), ("a/b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("a/" : GoString), Go.str()) : Slice<GoString>), ("a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, Go.str(), Go.str()) : Slice<GoString>), Go.str()) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("/" : GoString), ("a" : GoString), ("b" : GoString)) : Slice<GoString>), ("/a/b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest)) : Slice<stdgo.path.filepath_test.Filepath_test.JoinTest>);
/**
    
    
    
**/
private var _nonwinjointests = (new Slice<stdgo.path.filepath_test.Filepath_test.JoinTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("//" : GoString), ("a" : GoString)) : Slice<GoString>), ("/a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest)) : Slice<stdgo.path.filepath_test.Filepath_test.JoinTest>);
/**
...
0,
0,
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("directory" : GoString), ("file" : GoString)) : Slice<GoString>), ("directory\\file" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:\\Windows\\" : GoString), ("System32" : GoString)) : Slice<GoString>), ("C:\\Windows\\System32" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:\\Windows\\" : GoString), Go.str()) : Slice<GoString>), ("C:\\Windows" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:\\" : GoString), ("Windows" : GoString)) : Slice<GoString>), ("C:\\Windows" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:" : GoString), ("a" : GoString)) : Slice<GoString>), ("C:a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:" : GoString), ("a\\b" : GoString)) : Slice<GoString>), ("C:a\\b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:" : GoString), ("a" : GoString), ("b" : GoString)) : Slice<GoString>), ("C:a\\b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:" : GoString), Go.str(), ("b" : GoString)) : Slice<GoString>), ("C:b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:" : GoString), Go.str(), Go.str(), ("b" : GoString)) : Slice<GoString>), ("C:b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:" : GoString), Go.str()) : Slice<GoString>), ("C:." : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:" : GoString), Go.str(), Go.str()) : Slice<GoString>), ("C:." : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:" : GoString), ("\\a" : GoString)) : Slice<GoString>), ("C:\\a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:" : GoString), Go.str(), ("\\a" : GoString)) : Slice<GoString>), ("C:\\a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:." : GoString), ("a" : GoString)) : Slice<GoString>), ("C:a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:a" : GoString), ("b" : GoString)) : Slice<GoString>), ("C:a\\b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("C:a" : GoString), ("b" : GoString), ("d" : GoString)) : Slice<GoString>), ("C:a\\b\\d" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\\\host\\share" : GoString), ("foo" : GoString)) : Slice<GoString>), ("\\\\host\\share\\foo" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\\\host\\share\\foo" : GoString)) : Slice<GoString>), ("\\\\host\\share\\foo" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("//host/share" : GoString), ("foo/bar" : GoString)) : Slice<GoString>), ("\\\\host\\share\\foo\\bar" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\" : GoString)) : Slice<GoString>), ("\\" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\" : GoString), Go.str()) : Slice<GoString>), ("\\" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\" : GoString), ("a" : GoString)) : Slice<GoString>), ("\\a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\\\" : GoString), ("a" : GoString)) : Slice<GoString>), ("\\\\a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\" : GoString), ("a" : GoString), ("b" : GoString)) : Slice<GoString>), ("\\a\\b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\\\" : GoString), ("a" : GoString), ("b" : GoString)) : Slice<GoString>), ("\\\\a\\b" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\" : GoString), ("\\\\a\\b" : GoString), ("c" : GoString)) : Slice<GoString>), ("\\a\\b\\c" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\\\a" : GoString), ("b" : GoString), ("c" : GoString)) : Slice<GoString>), ("\\\\a\\b\\c" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("\\\\a\\" : GoString), ("b" : GoString), ("c" : GoString)) : Slice<GoString>), ("\\\\a\\b\\c" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest),
(new stdgo.path.filepath_test.Filepath_test.JoinTest((new Slice<GoString>(0, 0, ("//" : GoString), ("a" : GoString)) : Slice<GoString>), ("\\\\a" : GoString)) : stdgo.path.filepath_test.Filepath_test.JoinTest)) : Slice<stdgo.path.filepath_test.Filepath_test.JoinTest>);
/**
    
    
    
**/
private var _exttests = (new Slice<stdgo.path.filepath_test.Filepath_test.ExtTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.ExtTest(("path.go" : GoString), (".go" : GoString)) : stdgo.path.filepath_test.Filepath_test.ExtTest), (new stdgo.path.filepath_test.Filepath_test.ExtTest(("path.pb.go" : GoString), (".go" : GoString)) : stdgo.path.filepath_test.Filepath_test.ExtTest), (new stdgo.path.filepath_test.Filepath_test.ExtTest(("a.dir/b" : GoString), Go.str()) : stdgo.path.filepath_test.Filepath_test.ExtTest), (new stdgo.path.filepath_test.Filepath_test.ExtTest(("a.dir/b.go" : GoString), (".go" : GoString)) : stdgo.path.filepath_test.Filepath_test.ExtTest), (new stdgo.path.filepath_test.Filepath_test.ExtTest(("a.dir/" : GoString), Go.str()) : stdgo.path.filepath_test.Filepath_test.ExtTest)) : Slice<stdgo.path.filepath_test.Filepath_test.ExtTest>);
/**
    
    
    
**/
private var _tree = (Go.setRef((new Node(("testdata" : GoString), (new Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>(0, 0, (new stdgo.path.filepath_test.Filepath_test.Node(("a" : GoString), (null : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : stdgo.path.filepath_test.Filepath_test.Node), (new stdgo.path.filepath_test.Filepath_test.Node(("b" : GoString), (new Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>(0, 0) : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : stdgo.path.filepath_test.Filepath_test.Node), (new stdgo.path.filepath_test.Filepath_test.Node(("c" : GoString), (null : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : stdgo.path.filepath_test.Filepath_test.Node), (new stdgo.path.filepath_test.Filepath_test.Node(("d" : GoString), (new Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>(0, 0, (new stdgo.path.filepath_test.Filepath_test.Node(("x" : GoString), (null : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : stdgo.path.filepath_test.Filepath_test.Node), (new stdgo.path.filepath_test.Filepath_test.Node(("y" : GoString), (new Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>(0, 0) : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : stdgo.path.filepath_test.Filepath_test.Node), (new stdgo.path.filepath_test.Filepath_test.Node(("z" : GoString), (new Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>(0, 0, (new stdgo.path.filepath_test.Filepath_test.Node(("u" : GoString), (null : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : stdgo.path.filepath_test.Filepath_test.Node), (new stdgo.path.filepath_test.Filepath_test.Node(("v" : GoString), (null : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : stdgo.path.filepath_test.Filepath_test.Node)) : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : stdgo.path.filepath_test.Filepath_test.Node)) : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : stdgo.path.filepath_test.Filepath_test.Node)) : Slice<Ref<stdgo.path.filepath_test.Filepath_test.Node>>), (0 : GoInt)) : Node)) : Ref<stdgo.path.filepath_test.Filepath_test.Node>);
/**
...
**/
private var _winbasetests = (new Slice<stdgo.path.filepath_test.Filepath_test.PathTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.PathTest(("c:\\" : GoString), ("\\" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("c:." : GoString), ("." : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("c:\\a\\b" : GoString), ("b" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("c:a\\b" : GoString), ("b" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("c:a\\b\\c" : GoString), ("c" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("\\\\host\\share\\" : GoString), ("\\" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("\\\\host\\share\\a" : GoString), ("a" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest), (new stdgo.path.filepath_test.Filepath_test.PathTest(("\\\\host\\share\\a\\b" : GoString), ("b" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest)) : Slice<stdgo.path.filepath_test.Filepath_test.PathTest>);
/**
...
**/
private var _nonwindirtests = (new Slice<stdgo.path.filepath_test.Filepath_test.PathTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.PathTest(("////" : GoString), ("/" : GoString)) : stdgo.path.filepath_test.Filepath_test.PathTest)) : Slice<stdgo.path.filepath_test.Filepath_test.PathTest>);
/**
...
**/
private var _isabstests = (new Slice<stdgo.path.filepath_test.Filepath_test.IsAbsTest>(0, 0, (new stdgo.path.filepath_test.Filepath_test.IsAbsTest(Go.str(), false) : stdgo.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo.path.filepath_test.Filepath_test.IsAbsTest(("/" : GoString), true) : stdgo.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo.path.filepath_test.Filepath_test.IsAbsTest(("/usr/bin/gcc" : GoString), true) : stdgo.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo.path.filepath_test.Filepath_test.IsAbsTest((".." : GoString), false) : stdgo.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo.path.filepath_test.Filepath_test.IsAbsTest(("/a/../bb" : GoString), true) : stdgo.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo.path.filepath_test.Filepath_test.IsAbsTest(("." : GoString), false) : stdgo.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo.path.filepath_test.Filepath_test.IsAbsTest(("./" : GoString), false) : stdgo.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo.path.filepath_test.Filepath_test.IsAbsTest(("lala" : GoString), false) : stdgo.path.filepath_test.Filepath_test.IsAbsTest)) : Slice<stdgo.path.filepath_test.Filepath_test.IsAbsTest>);
/**
...
**/
private var _absTestDirs = (new Slice<GoString>(0, 0, ("a" : GoString), ("a/b" : GoString), ("a/b/c" : GoString)) : Slice<GoString>);
/**
...
**/
private var _winreltests = (new Slice<stdgo.path.filepath_test.Filepath_test.RelTests>(0, 0, (new stdgo.path.filepath_test.Filepath_test.RelTests(("C:a\\b\\c" : GoString), ("C:a/b/d" : GoString), ("..\\d" : GoString)) : stdgo.path.filepath_test.Filepath_test.RelTests), (new stdgo.path.filepath_test.Filepath_test.RelTests(("C:\\" : GoString), ("D:\\" : GoString), ("err" : GoString)) : stdgo.path.filepath_test.Filepath_test.RelTests), (new stdgo.path.filepath_test.Filepath_test.RelTests(("C:" : GoString), ("D:" : GoString), ("err" : GoString)) : stdgo.path.filepath_test.Filepath_test.RelTests), (new stdgo.path.filepath_test.Filepath_test.RelTests(("C:\\Projects" : GoString), ("c:\\projects\\src" : GoString), ("src" : GoString)) : stdgo.path.filepath_test.Filepath_test.RelTests), (new stdgo.path.filepath_test.Filepath_test.RelTests(("C:\\Projects" : GoString), ("c:\\projects" : GoString), ("." : GoString)) : stdgo.path.filepath_test.Filepath_test.RelTests), (new stdgo.path.filepath_test.Filepath_test.RelTests(("C:\\Projects\\a\\.." : GoString), ("c:\\projects" : GoString), ("." : GoString)) : stdgo.path.filepath_test.Filepath_test.RelTests), (new stdgo.path.filepath_test.Filepath_test.RelTests(("\\\\host\\share" : GoString), ("\\\\host\\share\\file.txt" : GoString), ("file.txt" : GoString)) : stdgo.path.filepath_test.Filepath_test.RelTests)) : Slice<stdgo.path.filepath_test.Filepath_test.RelTests>);
/**
...
function exampleRel():Void {
        var _paths = (new Slice<GoString>(0, 0, ("/a/b/c" : GoString), ("/b/c" : GoString), ("./b/c" : GoString)) : Slice<GoString>);
...
function exampleSplit():Void {
        var _paths = (new Slice<GoString>(0, 0, ("/home/arnie/amelia.jpg" : GoString), ("/mnt/photos/" : GoString), ("rabbit.jpg" : GoString), ("/usr/local//go" : GoString)) : Slice<GoString>);
        stdgo.fmt.Fmt.println(Go.toInterface(("On Unix:" : GoString)));
        for (__0 => _p in _paths) {
...
function testGlob(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (__1 => _pattern in (new Slice<GoString>(0, 0, ("no_match" : GoString), ("../*/no_match" : GoString)) : Slice<GoString>)) {
            var __tmp__ = glob(_pattern), _matches:Slice<GoString> = __tmp__._0, _err:Error = __tmp__._1;
            if (_err != null) {
                _t.errorf(("Glob error for %q: %s" : GoString), Go.toInterface(_pattern), Go.toInterface(_err));
                continue;
...
function testWindowsGlob(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            ...
            var _dirs = (new Slice<GoString>(0, 0, ("a" : GoString), ("b" : GoString), ("dir/d/bin" : GoString)) : Slice<GoString>);
            var _files = (new Slice<GoString>(0, 0, ("dir/d/bin/git.exe" : GoString)) : Slice<GoString>);
...
0,
0,
(new stdgo.path.filepath_test.Filepath_test.T_globTest(("a" : GoString), (new Slice<GoString>(0, 0, ("a" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.T_globTest),
(new stdgo.path.filepath_test.Filepath_test.T_globTest(("b" : GoString), (new Slice<GoString>(0, 0, ("b" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.T_globTest),
...
(new stdgo.path.filepath_test.Filepath_test.T_globTest(("*" : GoString), (new Slice<GoString>(0, 0, ("a" : GoString), ("b" : GoString), ("dir" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.T_globTest),
(new stdgo.path.filepath_test.Filepath_test.T_globTest(("d*" : GoString), (new Slice<GoString>(0, 0, ("dir" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.T_globTest),
(new stdgo.path.filepath_test.Filepath_test.T_globTest(("*i*" : GoString), (new Slice<GoString>(0, 0, ("dir" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.T_globTest),
(new stdgo.path.filepath_test.Filepath_test.T_globTest(("*r" : GoString), (new Slice<GoString>(0, 0, ("dir" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.T_globTest),
(new stdgo.path.filepath_test.Filepath_test.T_globTest(("?ir" : GoString), (new Slice<GoString>(0, 0, ("dir" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.T_globTest),
...
(new stdgo.path.filepath_test.Filepath_test.T_globTest(("d*/*/bin/git.exe" : GoString), (new Slice<GoString>(0, 0, ("dir/d/bin/git.exe" : GoString)) : Slice<GoString>)) : stdgo.path.filepath_test.Filepath_test.T_globTest)) : Slice<stdgo.path.filepath_test.Filepath_test.T_globTest>);
...
function testNonWindowsGlobEscape(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _want = (new Slice<GoString>(0, 0, ("match.go" : GoString)) : Slice<GoString>);
        var __tmp__ = glob(_pattern), _matches:Slice<GoString> = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
...
function testWalkFileError(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            ...
            var _want = ({
                final x = new GoMap<GoString, Error>();
                x.__setInitData__([("." : GoString) => null, ("foo" : GoString) => null, ("bar" : GoString) => null, ("dir" : GoString) => null, ("dir/baz" : GoString) => null, ("dir/stat-error" : GoString) => _statErr]);
                x;
            });
...
function testIssue13582(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _tests = (new Slice<T__struct_2>(0, 0, ({ _path : _dir, _want : _realDir } : T__struct_2), ({ _path : _linkToDir, _want : _realDir } : T__struct_2), ({ _path : _file, _want : _realFile } : T__struct_2), ({ _path : _link1, _want : _realFile } : T__struct_2), ({ _path : _link2, _want : _realFile } : T__struct_2)) : Slice<T__struct_2>);
...
private function _testWalkSymlink(_t:Ref<stdgo.testing.Testing.T>, _mklink:(_target:GoString, _link:GoString) -> Error):Void {
        ...
        try {
            ...
            var _want = (new Slice<GoString>(0, 0, ("." : GoString), ("link" : GoString)) : Slice<GoString>);
...
function testEvalSymlinksAboveRoot(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _wantSuffix:GoString = stdgo.strings.Strings.join((new Slice<GoString>(0, 0, ("a" : GoString), ("file" : GoString)) : Slice<GoString>), ((47 : GoInt32) : GoString));
        for (__0 => _i in (new Slice<GoInt>(0, 0, _c, _c + (1 : GoInt), _c + (2 : GoInt)) : Slice<GoInt>)) {
            var _check:GoString = stdgo.strings.Strings.join((new Slice<GoString>(0, 0, _evalTmpDir, stdgo.strings.Strings.join((_dd.__slice__(0, _i) : Slice<GoString>), ((47 : GoInt32) : GoString)), (_evalTmpDir.__slice__((_vol.length) + (1 : GoInt)) : GoString), ("b" : GoString), ("file" : GoString)) : Slice<GoString>), ((47 : GoInt32) : GoString));
...
function testIssue51617(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            ...
            var _want = (new Slice<GoString>(0, 0, ("." : GoString), ("a" : GoString), stdgo.path.filepath.Filepath.join(("a" : GoString), ("bad" : GoString)), stdgo.path.filepath.Filepath.join(("a" : GoString), ("next" : GoString))) : Slice<GoString>);
