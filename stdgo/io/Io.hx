...
@:keep @:allow(stdgo.io.Io.T__struct_43_asInterface) class T__struct_43_static_extension {

}
@:local @:using(stdgo.io.Io.T__struct_43_static_extension) private typedef T__struct_43 = {};
/**
